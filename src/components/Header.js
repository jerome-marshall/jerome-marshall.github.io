...
const Header = () => {
  ...
  return (
    <nav className="fixed inset-0 flex h-20 w-full items-center border-b-2 border-background_2 dark:border-dark-background_2 bg-background_1 px-5 dark:bg-dark-background_1">
